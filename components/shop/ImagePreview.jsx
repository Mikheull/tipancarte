    ...
    <div style={{width: "540px", height: "720px", position: 'absolute', top: 0, left: "200%"}}>
      <svg xmlns="http://www.w3.org/2000/svg" width="540px" height="720px" viewBox="0 0 540 720" id="preview_tipancarte">
        ...
        {choosenColor.logo == 'dark' ? (
          <svg xmlns="http://www.w3.org/2000/svg" width="200px" height="42px" viewBox="0 0 200 42" x="160" y="40">
            <g id="calque_logo_dark" >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="200px" height="42px" viewBox="0 0 200 42" x="160" y="40">
            <g id="calque_logo_light" data-name="Calque 1">
