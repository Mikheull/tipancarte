...
const template = compile(`
    <mjml>
        ...
        <mj-section padding="20px 0 20px 0" border-bottom="1px solid #dde6ed">
            ...
            <mj-text font-size="20px" align="center">Une nouvelle commande est en attente! 🙏</mj-text>
            </mj-column>
        </mj-section>
        ...
        <mj-section background-color="#FFF" padding="0 0 0 0">
            <mj-column>
            <mj-text color="#4a5568"><b>Commentaire:</b> {{order_comment}}</mj-text>
            <mj-spacer height="20px" />
            </mj-column>
        </mj-section>
...
export const createOrderAdmin = async (order_id, order_status, order_date, number_items, number_items_plural, order_subtotal, order_discount, order_shipping, order_total, order_comment, payment_method, payment_date, shipping_address, shipping_city, shipping_postal_code, shipping_country, order_link) => {
  const context = {order_id, order_status, order_date, number_items, number_items_plural, order_subtotal, order_discount, order_shipping, order_total, order_comment, payment_method, payment_date, shipping_address, shipping_city, shipping_postal_code, shipping_country, order_link};
