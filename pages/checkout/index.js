...
const billingOptions = ['Même que l\'adresse de livraison', 'Utiliser une adresse différente de paiement'];
...
class CheckoutPage extends Component {
  ...
  handleDiscountChange(e) {
    ...
    this.props.dispatchSetDiscountCodeInCheckout(this.props.checkout.id, this.state.discountCode)
      ...
      .catch(error => {
        alert('Désolé, le coupon n\'est pas valide !');
      });
  }
  ...
  captureOrder(e) {
    ...
    const newOrder = {
      ...
      billing: this.state.selectedBillingOption === 'Même que l\'adresse de livraison' ? shippingAddress : {
                  ...
                  <form onChange={this.handleChangeForm} onSubmit={this.captureOrder}>
                    ...
                    <div className="mb-5">
                        ...
                        <div className="col-12 mb-3">
                          <label className="w-100">
                            ...
                            <Dropdown
                              ...
                              placeholder="Selectionner une méthode de livraison"
                            >
                              {
                      ...
                      <label className="w-100 mb-3">
                        <p className="mb-1 font-size-caption font-color-light">
                          Notes sur la commande, détails, informations...
                        </p>
                    ...
                    { checkout.collects && checkout.collects.billing_address && <>
                      ...
                      {this.state.selectedBillingOption === 'Utiliser une adresse différente de paiement' && (
                        <AddressForm
                          type="billing"
                          countries={this.state.countries}
                          name={this.state['billing[name]']}
              ...
              <div className="bg-brand200 p-lg-5 p-3 checkout-summary">
                ...
                <div className="py-3 borderbottom border-color-black">
                  {[
                    ...
                    {
                      name: 'Livraison',
                      amount: selectedShippingOption ? `${selectedShippingOption.description} - ${selectedShippingOption.price.formatted_with_symbol}` : 'Pas d\'option de livraison séléctionné',
                    },
                    {
                      name: 'Réduction',
                      amount: (checkout.live && checkout.live.discount && checkout.live.discount.code) ? `Économisez ${checkout.live.discount.amount_saved.formatted_with_symbol}` : 'Pas de réduction appliquée',
                    }
                  ].map((item, i) => (
