...
function Preview({ params }) {
    ...
    if(!loadedProduct) return (
        <Layout title={`Chargement en cours`} description="Prenez inspiration dans cette pancarte créé par un de nos utilisateurs et ajoutez la dans votre panier pour passer commande." actual="shop" og_image={productDetails.image_preview} og_image_width="540" og_image_height="720">
